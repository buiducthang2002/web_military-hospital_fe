...
const content = `
<p>Trong năm, Bệnh viện đã khám 100.391 lượt, tăng 6,6% so với năm 2024; đẩy mạnh ứng dụng công nghệ thông tin, triển khai bệnh án điện tử, chuyển đổi số trong quản lý và điều hành khám chữa bệnh; hoàn thiện, làm chủ nhiều kỹ thuật đã triển khai, phối hợp các bệnh viện tuyến trên đào tạo, chuyển giao kỹ thuật mới; tổ chức kiểm tra điều dưỡng, kỹ thuật viên; triển khai mô hình giao tiếp AIDET; củng cố mạng lưới kiểm soát nhiễm khuẩn; bảo đảm đầy đủ cơ sở vật chất, thuốc, hóa chất, trang thiết bị y tế phục vụ công tác khám chữa bệnh...</p>
<div style="margin: 20px 0; text-align: center;">
    <img src="{{ttbv86.jpg}}"  style="max-width: 100%; height: auto; border-radius: 8px;" />
    <p style="margin-top: 10px; font-style: italic; color: #666; font-size: 14px;">Đại tá Phạm Đức Tuấn, Phó bí thư Đảng ủy, Cục trưởng Cục Hậu cần - Kỹ thuật Quân khu 4 dự và chỉ đạo hội nghị.</p>
  </div>  
